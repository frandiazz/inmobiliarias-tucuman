...
export default function PropertyGallery({ images, title }: PropertyGalleryProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
      <div className="lg:col-span-2 relative aspect-[4/3] rounded-2xl overflow-hidden bg-slate-100">
      ...
      <div className="hidden lg:flex flex-col gap-3">
        {thumbs.map((src, i) => (
          <button
            ...
            className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-slate-100 ring-2 ring-transparent hover:ring-teal-500 transition-all"
          >
